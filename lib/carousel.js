...
var Carousel = (0, _createReactClass2['default'])({
  ...
  handleSliderRef: function handleSliderRef(el) {
    this.slider = el;
  },

  handleListRef: function handleListRef(el) {
    this.list = el;
  },

  handleFrameRef: function handleFrameRef(el) {
    this.frame = el;
  },
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      'div',
      { className: ['slider', this.props.className || ''].join(' '), ref: this.handleSliderRef, style: (0, _objectAssign2['default'])(this.getSliderStyles(), this.props.style || {}) },
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'ul',
          { className: 'slider-list', ref: this.handleListRef, style: this.getListStyles() },
          children
        )
      ),
